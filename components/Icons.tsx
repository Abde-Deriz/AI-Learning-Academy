...
export const BrainIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.98-1.58 2.5 2.5 0 0 1-2.04-3.32A2.5 2.5 0 0 1 5 11.5V9a2.5 2.5 0 0 1 4.5-2Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.98-1.58 2.5 2.5 0 0 0 2.04-3.32A2.5 2.5 0 0 0 19 11.5V9a2.5 2.5 0 0 0-4.5-2Z"/></svg>
);
...
export const GamepadIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="6" x2="10" y1="12" y2="12"/><line x1="8" x2="8" y1="10" y2="14"/><line x1="15" x2="15.01" y1="13" y2="13"/><line x1="18" x2="18.01" y1="10" y2="10"/><path d="M17.32 5H6.68a4 4 0 0 0-3.978 3.59c-.006.052-.01.101-.01.152v3.516c0 .05.004.1.01.152A4 4 0 0 0 6.68 19h10.64a4 4 0 0 0 3.978-3.59c.006-.052.01-.101.01-.152V8.742c0-.05-.004-.1-.01-.152A4 4 0 0 0 17.32 5Z"/></svg>
);

export const PuzzleIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19.439 7.852c-2.435-2.443-6.422-2.443-8.858 0l-8.44 8.44a.999.999 0 0 0 0 1.414l2.483 2.483c.39.39 1.024.39 1.414 0 .39-.39.39-1.024 0-1.414l-1.72-1.721c1.613-1.613 4.24-1.613 5.854 0l.28.28c.39.39 1.024.39 1.414 0l2.122-2.121c.39-.39.39-1.024 0-1.414l-2.484-2.483c-1.612-1.612-4.24-1.612-5.852 0l-1.721-1.721c2.435-2.443 6.422-2.443 8.858 0l2.483 2.483c.39.39 1.024.39 1.414 0l2.483-2.483c.39-.39.39-1.024 0-1.414l-2.122-2.122Z"/></svg>
);

export const ChartIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 3v18h18"/><path d="M18 17v-6"/><path d="M13 17V7"/><path d="M8 17v-4"/></svg>
);
...
export const LightbulbIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 14c.2-1 .7-1.7 1.5-2.5C17.7 10.2 18 9 18 7.5c0-2.2-1.8-4-4-4-2.2 0-4 1.8-4 4 0 1.5.3 2.7 1.5 3.5.8.8 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>
);
...
export const ChallengeIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12z"/><path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/></svg>
);
...
export const GhostIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2a10 10 0 0 0-9.8 11.5c.1.9 1.1 1.5 2 1.5h15.6c.9 0 1.9-.6 2-1.5A10 10 0 0 0 12 2Z"/><circle cx="8.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="15.5" cy="10.5" r=".5" fill="currentColor"/><path d="M18 18v-3.5l-2 2-2-2-2 2-2-2v3.5"/></svg>
);

export const WorldIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 18 15.3 15.3 0 0 1-4-18zM12 2a15.3 15.3 0 0 0-4 18 15.3 15.3 0 0 0 4-18z"/></svg>
);

export const BrushIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="3" x2="15" y1="15" y2="3"/><path d="M15 13v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2Z"/></svg>
);

export const GlobeIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 18 15.3 15.3 0 0 1-4-18zM12 2a15.3 15.3 0 0 0-4 18 15.3 15.3 0 0 0 4-18z"/></svg>
);
...
export const FireIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22c-2 0-3.8-1.2-5-2.5-1.2-1.3-2-3-2-5.5 0-3.5 2.5-6.5 5-8.5 1.5-1.2 2.5-2.5 2.5-4C12.5 1 13 0 14 0c.8 0 1.5.5 1.5 1.5 0 1.5 1 2.8 2.5 4 2.5 2 5 5 5 8.5 0 2.5-.8 4.2-2 5.5-1.2 1.3-3 2.5-5 2.5z"/></svg>
);

export const ChildIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 2a2 2 0 1 1-4 0"/><path d="M4 22a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2Z"/><path d="M12 15a2 2 0 0 0-2-2H8v5h2a2 2 0 0 0 2-2Z"/><path d="M12 2a2 2 0 0 1-2 2c-1.1 0-2-.9-2-2"/><path d="M20 2a2 2 0 0 0-2 2c0 1.1.9 2 2 2"/><path d="M14 15a2 2 0 0 0 2-2h2v5h-2a2 2 0 0 1-2-2Z"/><path d="M9 11.5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5Z"/><path d="M16 11.5a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5Z"/></svg>
);
...
export const QuestionMarkCircleIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/><circle cx="12" cy="12" r="10"/></svg>
);

export const HatIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22s-8-4-8-10V5l8-3 8 3v7c0 6-8 10-8 10z"/><path d="M12 11.5L6.5 9M17.5 9L12 11.5M12 11.5V22M12 2L6.5 5 12 8l5.5-3L12 2z"/></svg>
);

export const GlassesIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="6" cy="15" r="4"/><circle cx="18" cy="15" r="4"/><path d="M14 15h-4"/><path d="M2.5 13L5 7c.7-1.3 1.4-2 3-2"/><path d="M21.5 13L19 7c-.7-1.3-1.4-2-3-2"/></svg>
);

export const StarAccessoryIcon = (props: SVGProps<SVGSVGElement>) => (
...
export const CuteBotIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1Z"/><path d="M9 17a1 1 0 0 0 1-1v-2a1 1 0 0 0-2 0v2a1 1 0 0 0 1 1Z"/><path d="M15 17a1 1 0 0 0 1-1v-2a1 1 0 0 0-2 0v2a1 1 0 0 0 1 1Z"/></svg>
);

export const WiseBotIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13h-6"/><path d="M15 17h-6"/><path d="M9 13v4"/></svg>
);

export const SuperBotIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="m9 13 2 2 2-2"/><path d="M9 17h6"/></svg>
);
...
export const GraduationCapIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 1.7 3 3 6 3s6-1.3 6-3v-5"/></svg>
);
...
export const TwitterIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 2.8 3.2 3 5.2-9.7.1-13.3-6.2-14.3-8.2s-1.7-2.4-2.7-3.5c-1.2-1.2-2.3-1-2.3-1 .4 2.1 2.3 3.8 4.5 5.2-2.3.1-4.6-.9-6.6-2.1C.5 12.7 2 17.1 6 19.3c-1.1.5-2.3.8-3.5.8s-2.4-.3-3.5-1c3 4.1 8.5 5.4 14 2.6 3.2-1.6 5.2-4.9 5.2-9.2z"/></svg>
);
...
export const InstagramIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
);
...
export const JigsawIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19.439 7.852c-2.435-2.443-6.422-2.443-8.858 0l-8.44 8.44a.999.999 0 0 0 0 1.414l2.483 2.483c.39.39 1.024.39 1.414 0 .39-.39.39-1.024 0-1.414l-1.72-1.721c1.613-1.613 4.24-1.613 5.854 0l.28.28c.39.39 1.024.39 1.414 0l2.122-2.121c.39-.39.39-1.024 0-1.414l-2.484-2.483c-1.612-1.612-4.24-1.612-5.852 0l-1.721-1.721c2.435-2.443 6.422-2.443 8.858 0l2.483 2.483c.39.39 1.024.39 1.414 0l2.483-2.483c.39-.39.39-1.024 0-1.414l-2.122-2.122Z"/></svg>
);

export const FillBlanksIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-4"/><path d="M12 5V2"/><path d="M12 5a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2"/><path d="M18 9h-4"/><path d="M18 13h-4"/><path d="M18 17h-4"/></svg>
);

export const DrawingIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3 16.828V21h4.172l14.002-14.002z"/><path d="m15 5 6 6"/></svg>
);
